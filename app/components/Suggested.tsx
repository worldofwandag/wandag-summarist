...
export default async function Suggested() {
  ...
  const suggestedBooks = await data.json();
      ...
      <div className="for-you__recommended--books">
        {suggestedBooks.map((suggestedBook: Books) => (
          ...
          <Link href={`/book/${suggestedBook.id}`} key={suggestedBook.id}>
            ...
            <audio src={suggestedBook.audioLink}></audio>

            <figure className="book__image--wrapper">
            <img src={suggestedBook.imageLink} />
            </figure>
            <div className="recommended__book--title">{suggestedBook.title} </div>
